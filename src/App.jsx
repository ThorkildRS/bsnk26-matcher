...
const BRAND = {
  ...
  muted: "#6b7280",
  border: "#e5e7eb",
  logo: "/speakers/bsnk-logo.png",
};

// Bytt ut bildene i /public/speakers/ med egne bilder (samme filnavn, sirkulært format anbefalt)
const TALKS = [
  { id: 1, title: "Skap verdi med BIM på tvers av porteføljen din", speaker: "Astrid Grøntved Starck", org: "Implement Consulting Group", time: "10:30", part: "DEL 1", tags: ["BIM", "Strategi", "Digitalt samarbeid"], emoji: "🎯", image: "/speakers/1.png", desc: "Fra digitale verktøy til helhetlig sammenheng — jobbe strategisk med digitale verktøy på tvers av partnere og prosjektporteføljer." },
  { id: 2, title: "Merverdi av bærekraft i eiendom", speaker: "Magnus Meland Røed", org: "DNB", time: "10:50", part: "DEL 1", tags: ["Bærekraft", "Finans", "Eiendom"], emoji: "🌱", image: "/speakers/2.jpg", desc: "Hva kan gi mulig merverdi og redusere risiko i bygg? DNB deler perspektiver i forbindelse med finansiering." },
  { id: 3, title: "Strategisk eiendomsforvaltning – digitalisering som beslutningsstøtte", speaker: "Anne Charlotte Moe", org: "Helse Sør-Øst", time: "11:10", part: "DEL 1", tags: ["Helse", "FM", "Beslutningsstøtte"], emoji: "🏥", image: "/speakers/3.jpg", desc: "Økt digitalisering av eiendomsforvaltningen — felles FM-system for drift og forvaltning av eiendommer." },
  { id: 4, title: "Agentic AI in Construction", speaker: "Henri Pitkänen & Kim Nyberg", org: "Trimble", time: "13:00", part: "DEL 2", tags: ["AI", "Automatisering", "MCP"], emoji: "🤖", image: "/speakers/4-1.png", image2: "/speakers/4-2.png", desc: "Fra passive AI-assistenter til Agentic AI — autonome, måldrevne arbeidsflyter med Tekla Model Assistant." },
  { id: 5, title: "MCP i byggebransjen – praktisk bruk i trygge rammer", speaker: "Jonn Øyvind Hosum", org: "Asplan Viak", time: "13:15", part: "DEL 2", tags: ["MCP", "AI", "Datasikkerhet"], emoji: "🔐", image: "/speakers/john.png", desc: "Hvordan nye standarder som MCP muliggjør bruk av KI i fagapplikasjoner uten å gi slipp på kontroll." },
  { id: 6, title: "åpenBIM på skinner", speaker: "Daniel Gomsrud", org: "Bane NOR", time: "13:30", part: "DEL 2", tags: ["IFC 4.3", "IDS", "Infrastruktur"], emoji: "🚂", image: "/speakers/daniel.jpg", desc: "BaneNORs syn på BIM og informasjonshåndtering. Dypdykk i krav med eksempler — IFC 4.3, IDS og BCF." },
  { id: 7, title: "AI og IFC som grunnlag for automatisert prosjektering", speaker: "Per Ström", org: "Multiconsult", time: "14:05", part: "DEL 2", tags: ["AI", "IFC", "Prosjektering"], emoji: "⚡", image: "/speakers/perstrom.jpg", desc: "IFC-modeller som strukturert datagrunnlag for AI-baserte analyser og automatisert plassering av tekniske installasjoner." },
  { id: 8, title: "Datasikkerhet og internasjonal datalagring", speaker: "Astrid Stenersen & Kine E. Helgeneseth", org: "Advokatfirmaet Selmer", time: "14:25", part: "DEL 2", tags: ["Juss", "Datasikkerhet", "Sky"], emoji: "⚖️", image: "/speakers/astrid.png", image2: "/speakers/KineE selmer.jpg", desc: "Utfordringer ved BIM-plattformer og skytjenester — risiko for at utenlandske myndigheter kan kreve utlevering av data." },
  { id: 9, title: "Åpen BIM i praksis: Gartnerløkka-prosjektet", speaker: "Marius Drevland & Mića Gavrić", org: "Rambøll", time: "14:45", part: "DEL 2", tags: ["åpenBIM", "IDS", "Vegprosjekt"], emoji: "🛣️", image: "/speakers/Marius Drevland.jpg", image2: "/speakers/Mića Gavrić.jpg", desc: "BIMbot-flyt med åpne standarder i E18/E39 Gartnerløkka. Bedre flyt, høyere datakvalitet og raskere beslutninger." },
  { id: 10, title: "IFC, bSDD and GS1 – how it all fits together", speaker: "Artur Tomczak & Knut Mathiesen", org: "buildingSMART Int. / GS1", time: "15:20", part: "DEL 3", tags: ["IFC", "Standarder", "Sporbarhet"], emoji: "🔗", image: "/speakers/artur.png", image2: "/speakers/knut.mat.jpg", desc: "GS1-identifikatorer koblet med IFC og bSDD — digital tråd for produkt- og anleggsinformasjon." },
  { id: 11, title: "En entreprenørs sømløse informasjonsflyt", speaker: "Egil Berg & Knut Jøssang", org: "NCC / Pipelife Norge", time: "15:40", part: "DEL 3", tags: ["Entreprenør", "Samhandling", "Effektivisering"], emoji: "🏗️", image: "/speakers/Egilberg.jpg", image2: "/speakers/knut.png", desc: "Sømløs informasjonsflyt for mer effektive prosesser, bedre beslutninger og tryggere prosjektgjennomføring." },
  { id: 12, title: "Prosjektering av bruer med BIM", speaker: "Gaute Nordbotten", org: "Statens vegvesen", time: "16:00", part: "DEL 3", tags: ["Bru", "BIM", "Regelverk"], emoji: "🌉", image: "/speakers/GauteNordbotten_trykk (1).jpg", desc: "9 år med BIM-modeller til prosjekteringskontroll — erfaringer og arbeid knyttet til regelverk." },
  { id: 13, title: "Bruk av KI og gamification", speaker: "Berna Shalci & Sofie I. Nicolaisen", org: "Newbringer / Standard Norge", time: "16:35", part: "DEL 4", tags: ["AI", "Gamification", "Standarder"], emoji: "🎮", image: "/speakers/berna.jpg", image2: "/speakers/Sofie.png", desc: "Utforsk hvordan kunstig intelligens og gamification kan brukes i BAE-bransjen." },
  { id: 14, title: "BIM/digitalisering for gjenoppbygging av Ukraina", speaker: "Katrin Johannesdottir", org: "VDC Infra", time: "16:55", part: "DEL 4", tags: ["Ukraina", "BIM", "Gjenoppbygging"], emoji: "💙", image: "/speakers/katrin.jpg", desc: "Hvordan BIM og digitalisering kan bidra til gjenoppbygging etter krig." }
];
